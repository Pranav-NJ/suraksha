...
export default function SimpleParentDashboard() {
  ...
  // Calculate active alerts count - safe check for array
  const alertsArray = Array.isArray(emergencyAlerts) ? emergencyAlerts as EmergencyAlert[] : [];
  const activeAlertsCount = alertsArray.filter(alert => alert.status === 'active').length;
  ...
  useEffect(() => {
    const activeAlerts = Array.isArray(emergencyAlerts) ? (emergencyAlerts as EmergencyAlert[]).filter(alert => alert.status === 'active') : [];
    ...
    <div className="space-y-6">
      ...
      <Card className="border-red-200 bg-red-50">
        ...
        <CardContent>
          {alertsLoading ? (
          ...
          ) : !Array.isArray(emergencyAlerts) || (emergencyAlerts as EmergencyAlert[]).length === 0 ? (
            ...
            <div className="space-y-4">
              {Array.isArray(emergencyAlerts) && (emergencyAlerts as any[]).map((alert) => (
                <div
                  key={alert.id}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 flex-shrink-0">
              ...
              >
                ...
                {Array.isArray(emergencyAlerts) && (emergencyAlerts as EmergencyAlert[]).filter(alert => alert.status === 'active').length > 0 && (
